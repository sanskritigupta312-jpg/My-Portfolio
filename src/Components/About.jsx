    ...
    <div className="text-white md:flex overflow-hidden items-center md:flex-wrap md:justify-center bg-black shadow-xl m-2 md:mx-20 bg-opacity-30 rounded-lg p-8 md:p-12">
      <div>
        ...
        <div className="md:flex flex-wrap flex-col md:flex-row items-center">
          <img
            className="md:h-80 rounded-2xl mb-8 md:mb-0"
            src={AboutImg}
            alt="Sanskriti Kumari"
          />
          ...
          <ul className="md:ml-10">
            ...
            <div className="flex gap-3 py-4">
              ...
              <span className="max-w-md">
                ...
                <p className="text-sm md:text-md text-gray-300">
                  I am a BTech Computer Science Engineering student at Kalinga
                  University (2024-Present) with a passion for building
            ...
            <div className="flex gap-3 py-4">
              ...
              <span className="max-w-md">
                ...
                <p className="text-sm md:text-md text-gray-300">
                  Currently pursuing BTech at Kalinga University, Raipur.
                  Completed Class XII (69.4%) and Class X (78.6%) at Adarsh
                  Vidya Mandir, Jharkhand.
                </p>
              </span>
            </div>
            ...
            <div className="flex gap-3 py-4">
              ...
              <span className="max-w-md">
                ...
                <p className="text-sm md:text-md text-gray-300">
                  ...
                  <strong>Backend/DB:</strong> Firebase (Auth & Firestore).{" "}
                  <br />
            ...
            <div className="flex gap-3 py-4">
              ...
              <span className="max-w-md">
                ...
                <div className="mt-3 space-y-5 text-sm md:text-base">
                  <div>
